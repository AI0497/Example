package com.example.ai_bot.example;
...
public class MemberListActivity extends AppCompatActivity {
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        private final MemberListActivity mParentActivity;
        ...
        SimpleItemRecyclerViewAdapter(MemberListActivity parent,
        ...
        class ViewHolder extends RecyclerView.ViewHolder {
            final ImageView mImageViewPhoto;
            final TextView mTextViewName;

            ViewHolder(View view) {
                super(view);
                mImageViewPhoto = (ImageView) view.findViewById(R.id.iv_member_photo);
